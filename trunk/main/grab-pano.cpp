...
// Grabs hard-coded panoramic images from one or both cameras
...
int main(int argc, char* argv[])
{
  ...
  PanoramicCamera cameraL ("cameraL", ImgCap_base::V4L2, "/dev/video0", 2,
			   CamCtrl_base::BRC300, "/dev/ttyUSB1", 1);
  PanoramicCamera cameraR ("cameraR", ImgCap_base::V4L2, "/dev/video1", 2,
			   CamCtrl_base::BRC300,"/dev/ttyUSB0", 1);
