...
namespace libviscaBRC300 {
  ...
  char iris_lookup_table(double f); // pick an f-stop
  ...
  // change between automatic and manual exposure mode
  ...
  // manually set the shutter speed -- 0x02 = 1/3 sec, 0x06 = normal, 0x15 = fastest
